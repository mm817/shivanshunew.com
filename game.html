...
<body>
    ...
    <div class="details">
        <h1>M-REX TECH YT</h1>
        <h3>GOOD LUCK YOU HAVE ONLY 12 SECOND LEGEND </h3>
        <h2>GAME WILL STOP IN 12 SECOND </h2>
        <div class="level">
            <button onclick="easy()">noob</button>
            <button onclick="medium()">pro</button>
            <button onclick="hard()">legend</button>
        </div>
